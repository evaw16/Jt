    ...
    <div id="sidebar">
      <div id="sidebar-wrapper">
        ...
        <ul class="sidebar-nav">
          ...
          <li class="active"><a href="fartikel.php"><i class="fa fa-fw fa-font"></i><span>Artikel</span></a></li>
          <li>
          ...
          <nav class="navbar navbar-default">
            <div class="container-fluid">
              <div class="navbar-header">
                ...
                <a class="navbar-brand text-size-24" href="#"><i class="fa fa-list-alt"></i> Artikel</a>
              </div>
