				...
				<ul class="sidebar-nav">
					...
					<!-- <li>
						...
						<ul class="sidebar-nav-child collapse collapseable" id="nav-dropdown1">
							...
							<li><a href="proposal.php"><i class="fa fa-fw fa-window-restore"></i><span>Proposal</span></a></li>
						</ul>
					</li> -->
				</ul>
			</div>
							...
							<div class="panel-body">
								<form class="form-horizontal" method="post">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="date" data-date-format="yyyy-MM-dd" class="form-control input-lg" placeholder="Tanggal" name="tanggal">
										</div>
									</div>
									<div class="form-group">
...
if (isset($_POST['submit'])) {
	...
	header("location:rekaptiketad.php?tanggal=$tanggal");
	exit();
}
?>
